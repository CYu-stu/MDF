...
def test_parser():
    ...
    parser.add_argument("--disturb_num", help="channel number", type=int, default=5)
    parser.add_argument("--short_cut_weight", help="short cut weight", type=float, default=0.05)
...
args = test_parser()
model = DRN(resnet=False,args=args)
model.cuda()

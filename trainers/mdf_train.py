...
def default_train(train_loader, model, optimizer, writer, iter_counter, args):
    ...
    for i, (inp, _) in enumerate(train_loader):
        ...
        cos_f3,cos_f4,cos_f5,cos_f6 = model(inp)

        loss_f3 = criterion(cos_f3, target)
        loss_f4 = criterion(cos_f4, target)
        loss_f5 = criterion(cos_f5, target)
        loss_f6 = criterion(cos_f6, target)
        # loss_f7 = criterion(cos_f7, target)
        loss = loss_f3 + loss_f4 + loss_f5 + loss_f6 

...
def default_train(train_loader,model,optimizer,writer,iter_counter,print_interval=5):
    way = model.way
    ...
    writer.add_scalar('drn_loss',avg_loss,iter_counter)
